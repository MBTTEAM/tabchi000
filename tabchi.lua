...
function process(msg)
  ...
  do
    ...
    if msg.text:match("^[!/#]setanswer") and is_sudo(msg) and #matches == 3 then
      ...
      return "_Å«”Œ »—«Ì_ " .. matches[2] .. " >> " .. matches[3]
    end
  end
  do
    local matches = {
    ...
    if msg.text:match("^[!/#]delanswer") and is_sudo(msg) and #matches == 2 then
      ...
      return "_Å«”Œ »—«Ì_ " .. matches[2] .. " _Õ–› ‘œ_"
    end
  end
  if msg.text:match("^[!/#]answers$") and is_sudo(msg) then
    local text = "_·Ì”  Å«”Œ Â«Ì ŒÊœò«—_ :\n"
...
_›Ê—Ê«—œ ÅÌ«„ »Â Â„Â/ê—ÊÂ Â«/”ÊÅ— ê—ÊÂ Â«/ò«—»—«‰_
*/echo (text)*
_ ò—«— „ ‰_
*/addedmsg (on/off)*
_ ⁄ÌÌ‰ —Ê‘‰ Ì« Œ«„Ê‘ »Êœ‰ Å«”Œ »—«Ì ‘— ‘‰ „Œ«ÿ»_
*/setaddedmsg (text)*
_ ⁄ÌÌ‰ „ ‰ «œ ‘œ‰ „Œ«ÿ»_
*/markread (on/off)*
_—Ê‘‰ Ì« Œ«„Ê‘ ò—œ‰ »«“œÌœ ÅÌ«„ Â«_
...
_·Ì”  ÃÊ«» Â«Ì « Ê„« Ìò_
*/addtoall*
_«÷«›Â ò—œ‰ „Œ«ÿ»Ì‰ —»«  »Â ê—ÊÂ_
*/addmembers*
_«÷«›Â ò—œ‰ ‘„«—Â Â« »Â „Œ«ÿ»Ì‰ —»« _
*/exportlinks*
_œ—Ì«›  ·Ì‰ò Â«Ì –ŒÌ—Â ‘œÂ  Ê”ÿ —»« _
*/contactlist*
_œ—Ì«›  „Œ«ÿ»«‰ –ŒÌ—Â ‘œÂ  Ê”ÿ —»« _
]]
    return text
  end
  do
...
 ⁄œ«œ ê—ÊÂ Â«Ì „⁄„Ê·Ì ‘„« : ]] .. gps .. [[
          
 ⁄œ«œ ”ÊÅ— ê—ÊÂ Â«Ì ‘„« : ]] .. sgps .. [[
          
 ⁄œ«œ ·Ì‰ò Â«Ì –ŒÌ—Â ‘œÂ ê—ÊÂ Â« : ]] .. links
  ...
  do
    ...
    if msg.text:match("^[!/#]addsudo") and is_full_sudo(msg) and #matches == 2 then
      local text = matches[2] .. " ? «Ì‰ ¬ﬁ« »« „Ê›ﬁÌ  »Â ·Ì”  «œ„Ì‰ Â« «÷«›Â ‘œ "
  ...
  do
    ...
    if msg.text:match("^[!/#]remsudo") and is_full_sudo(msg) and #matches == 2 then
      local text = matches[2] .. " «Ì‰ ¬ﬁ« »« „Ê›ﬁÌ  «“ ·Ì”  «œ„Ì‰ Â«Ì  »çÌ Õ–› ‘œ ????"
  ...
  do
    ...
    if msg.text:match("^[!/#]addedmsg") and is_sudo(msg) and #matches == 2 then
      if matches[2] == "on" then
        ...
        return "ÅÌ«„ «œœ ‘œ‰ „Œ«ÿ» Â« »« „Ê›ﬁÌ  ›⁄«· ‘œ ????"
      elseif matches[2] == "off" then
        redis:del("tabchi:" .. tabchi_id .. ":addedmsg")
        return "ÅÌ«„ «œœ ‘œ‰„Œ«ÿ» Â« »« „Ê›ﬁÌ  €Ì—›⁄«· ‘œ ????"
      end
    end
  end
  do
    ...
    if msg.text:match("^[!/#]markread") and is_sudo(msg) and #matches == 2 then
      if matches[2] == "on" then
        ...
        return "ŒÊ«‰œ‰ ÅÌ«„ Â«  Ê”ÿ  »çÌ »«„Ê›ﬁÌ  ›⁄«· ‘œ ????"
      elseif matches[2] == "off" then
        redis:del("tabchi:" .. tabchi_id .. ":markread")
        return "ŒÊ«‰œ‰ ÅÌ«„ Â«  Ê”ÿ  »çÌ ‘„« »«„Ê›ﬁÌ  €Ì—›⁄«· ‘œ ????"
      end
    end
  end
  do
